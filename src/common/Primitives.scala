...
trait LiftPrimitives {
  ...
  implicit def chainIntToRepFloat[A: Manifest](x: A)(implicit c: A => Rep[Int], sc: SourceContext): Rep[Float] = repIntToRepFloat(c(x))
  implicit def chainFloatToRepDouble[A: Manifest](x: A)(implicit c: A => Rep[Float], sc: SourceContext): Rep[Double] = repFloatToRepDouble(c(x))
}
...
trait PrimitiveOps extends Variables with OverloadHack {
   ...
   */
  implicit def repIntToRepDouble(x: Rep[Int])(implicit sc: SourceContext): Rep[Double] = x.toDouble
  implicit def repIntToRepFloat(x: Rep[Int])(implicit sc: SourceContext): Rep[Float] = x.toFloat
  implicit def repFloatToRepDouble(x: Rep[Float])(implicit sc: SourceContext): Rep[Double] = x.toDouble

  implicit class IntOps(lhs: Rep[Int]) {
    def -(rhs: Rep[Int])(implicit o: Overloaded1, ctx: SourceContext): Rep[Int] = int_minus(lhs, rhs)
    def -(rhs: Rep[Float])(implicit o: Overloaded2, ctx: SourceContext): Rep[Float] = float_minus(repIntToRepFloat(lhs), rhs)
  ...
  implicit class FloatOps(lhs: Rep[Float]) {
    def -(rhs: Rep[Int])(implicit o: Overloaded4, ctx: SourceContext): Rep[Float] = float_minus(lhs, repIntToRepFloat(rhs))
    def -(rhs: Rep[Float])(implicit o: Overloaded5, ctx: SourceContext): Rep[Float] = float_minus(lhs, rhs)
    def +(rhs: Rep[Int])(implicit o: Overloaded18, ctx: SourceContext): Rep[Float] = float_plus(lhs, repIntToRepFloat(rhs))
    def +(rhs: Rep[Float])(implicit o: Overloaded19, ctx: SourceContext): Rep[Float] = float_plus(lhs, rhs)
  ...
  def -(rhs: Rep[Float])(implicit o: Overloaded8, ctx: SourceContext): Rep[Double] = double_minus(lhs,repFloatToRepDouble(rhs))
  def -(rhs: Rep[Double])(implicit o: Overloaded9, ctx: SourceContext): Rep[Double] = double_minus(lhs,rhs)



  def +(rhs: Rep[Double])(implicit o: Overloaded20, ctx: SourceContext): Rep[Double] = double_plus(repFloatToRepDouble(lhs), rhs)
  def +(rhs: Rep[Int])(implicit o: Overloaded21, ctx: SourceContext): Rep[Double] = double_plus(lhs,repIntToRepDouble(rhs))
  def +(rhs: Rep[Float])(implicit o: Overloaded22, ctx: SourceContext): Rep[Double] = double_plus(lhs,repFloatToRepDouble(rhs))
  def +(rhs: Rep[Double])(implicit o: Overloaded23, ctx: SourceContext): Rep[Double] = double_plus(lhs,rhs)
  ...
  implicit def repDoubleToDoubleOps(n: Rep[Double])(implicit ctx: SourceContext): DoubleOpsCls = new DoubleOpsCls(n)
  implicit def varDoubleToDoubleOps(n: Var[Double])(implicit ctx: SourceContext): DoubleOpsCls = new DoubleOpsCls(readVar(n))
  ...
  implicit def varIntToIntOps(n: Var[Int])(implicit ctx: SourceContext): IntOpsCls = new IntOpsCls(readVar(n))
