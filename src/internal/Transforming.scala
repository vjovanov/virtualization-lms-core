...
trait LoweringTransform extends FatTransforming with Effects with scala.virtualization.lms.common.LoopsFatExp with scala.virtualization.lms.common.IfThenElseFatExp { self =>
