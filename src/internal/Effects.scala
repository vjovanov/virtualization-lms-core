...
object Effects {
  implicit def scef: SourceContext = new SourceContext{}
}
...
*/
    ...
    d match {
      case Reify(x,_,_) =>
        ...
        super.toAtom(d)
      case _ if conditionalScope && addControlDeps => reflectEffect(d, Control())(manifest[T], new SourceContext{})
      case _ => reflectEffect(d, Pure())(manifest[T], new SourceContext{})
    }
